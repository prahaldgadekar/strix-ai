...
class StrixBrain:
    ...
    def process(self, raw: str, stream: bool = False):
        ...
        # WORK  account (GitHub): prahaldgadekar64@gmail.com
        # MAIN  account (everything else): prahladgadekar1569@gmail.com
            ...
            import os
            _gh_user     = os.environ.get("GITHUB_USERNAME", "prahaldgakekar")
            _main_profile = os.environ.get("CHROME_PROFILE_MAIN", "Default")
            _work_profile = os.environ.get("CHROME_PROFILE_WORK", "Profile 1")
        ...
        # ==============================================================
            ...
            user = os.environ.get("GITHUB_USERNAME","prahaldgakekar")
        ...
        # "create a python file", "write code for X", "make a js file called Y"
                ...
                "create a python", "create python", "make a python",
                "create a javascript", "create javascript", "make a js",
                "create a html", "create html", "make a html",
                "create a file", "make a file", "new file",
                "write code", "write a code", "code for",
                "write a script", "create a script", "make a script",
                "write me a", "create a program",
            ]):
